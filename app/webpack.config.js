...
module.exports = {
  ...
  plugins: [
    new CopyWebpackPlugin([{ from: "./src/html/login.html", to: "login.html" }]),
    new CopyWebpackPlugin([{ from: "./src/js/auth.js", to: "js/auth.js" }]),
    new CopyWebpackPlugin([{ from: "./src/css/auth.css", to: "css/auth.css" }]),
    ...
    new CopyWebpackPlugin([{ from: "./src/html/impact-dashboard.html", to: "impact-dashboard.html" }]),
    new CopyWebpackPlugin([{ from: "./src/html/predict-success.html", to: "predict-success.html" }]),
    new CopyWebpackPlugin([{ from: "./src/html/patient-registration-simplified.html", to: "patient-registration-simplified.html" }]),
    new CopyWebpackPlugin([{ from: "./src/js/chatbot.js", to: "js/chatbot.js" }]),
    new CopyWebpackPlugin([{ from: "./src/js/translations.js", to: "js/translations.js" }]),
    new CopyWebpackPlugin([{ from: "./node_modules/bootstrap/dist/css/bootstrap.min.css", to: "css/bootstrap.css" }]),
